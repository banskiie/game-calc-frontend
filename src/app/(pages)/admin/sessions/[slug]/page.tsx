...
const Page = () => {
    ...
    const handleEndGame = (gameId: any) => {
        ...
        endGame({
            variables: { id: gameId, end: currentTime, status: 'completed' },
        })
            .then(() => {
                refetch()
    ...
    return (
        <div className="h-fit flex-1 overflow-auto w-full flex flex-col gap-4 p-4">
            ...
            <div className="flex flex-row justify-center gap-4 mt-4">
                ...
                <button
                    onClick={() =>
                        router.push(`/admin/sessions/view-summary/${slug}`)
                    }
            ...
            <div className="grid grid-cols-1 gap-4">
                {gameData?.fetchGamesBySession.length > 0 ? (
                    gameData?.fetchGamesBySession.map(
                                    ...
                                    <div className="grid grid-rows-3 grid-cols-3 gap-2">
                                        ...
                                        <div className="text-left flex flex-col items-center justify-center sm:flex-row sm:justify-start mt-[-50px]">
                                            <div className="flex flex-col items-center">
                                                ...
                                                {game.winner !== null && (
                                                    <span
                                                        className={`p-2 w-full sm:w-auto text-center`}
                                                    >
                                                        {game.winner === 'a' ? (
